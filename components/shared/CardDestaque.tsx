...
const CardDestaque = ({ titulo, descricao, Icone, link, className }: ICardDestaque) => {
   return (
      <Link href={link}>
         <div className={`text-white h-full py-14 md:py-20 xl:py-28 px-8 hover:border-x-2 ${className}`}>
            <Icone className="size-12" />
            <h6 className="mt-5 text-xl lg:text-2xl [&_span]:font-black [&_span]:text-4xl mb-2 text-shadow-lg">{titulo}</h6>
